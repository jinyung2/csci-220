/*  Java Class: SinglyLinkedList.java
    ...
    Class: CSCI220
    Date: 10/10/2017
    Description: Use a linked list to store a list of names, have methods to insert at front and rear, remove an element and print the contents. Uses Java Generics to implement the Stack ADT in the Stack.java class.
